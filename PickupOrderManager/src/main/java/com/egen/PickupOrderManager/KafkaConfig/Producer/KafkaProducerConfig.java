package com.egen.PickupOrderManager.KafkaConfig.Producer;
...
public class KafkaProducerConfig {
     ...
     * */
    @Bean
    public ProducerFactory<String, Pickup> producerFactoryJson() throws UnknownHostException {
        ...
        DefaultKafkaProducerFactory<String, Pickup> factory = new DefaultKafkaProducerFactory<>(configProps);
    ...
    @Bean
    public KafkaTemplate<String, Pickup> kafkaTemplateJson() throws UnknownHostException {
